...
def train():
    ...
    for year in range(2000,2018):
        ...
        data1=np.load('./EartherFormerResults/epochensemble/plot_era5_global_HR0.5_4ptensemble_'+str(year)+'.npz')
        data2=np.load('./Unet_Results/plot_era5_unet_global__'+str(year)+'.npz')
